...
internal class MailAddressJsonConverter : JsonConverter<MailAddress>
{
...
internal static class Parser
{
    ...
    public static Parsed Parse(string filepath)
    {
        ...
        try
        {
            ...
            parsed = JsonSerializer.Deserialize<Parsed>(content, new JsonSerializerOptions() { Converters = { new MailAddressJsonConverter() }});
        }
        catch (Exception e)
        {
            ErrorExit($"Failed to parse settings file: {e.Message}");
        }
